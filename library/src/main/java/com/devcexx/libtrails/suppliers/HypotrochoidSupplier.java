...
/**
 * Class that provides an Hypotrochoid trail.
 */
public class HypotrochoidSupplier extends SpirographSupplier {
     ...
     */
    public HypotrochoidSupplier(Particle particle, float delta,
